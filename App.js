    ...
    <View style={styles.container}>
      ...
      <View style={{ margin: 10 }}>
        ...
        <MapView
          ...
          region={mapViewerRegion}
        >
        <Marker 
          draggable 
          coordinate={mapViewerRegion} 
          title='Emplacement à signaler'
          onDragEnd={(e) => setMapViewerRegion(e.nativeEvent.coordinate)}
        />
        </MapView>
      </View>
      <View style={styles.bottom}>
        <Button props={{title: 'J\'Alerte ma Ville', icon:'bell-o'}} onPress={handleSubmit} />
      </View>
    </View>
  );
};
